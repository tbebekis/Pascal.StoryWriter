...
type
  ...
  TStoryListForm = class(TPageForm)
...
constructor TStoryListForm.Create(AOwner: TComponent);
begin
...
destructor TStoryListForm.Destroy();
begin
  inherited Destroy();
end;

procedure TStoryListForm.FormInitialize;
begin
...
procedure TStoryListForm.FormInitializeAfter();
begin
  pnlTop.Height := (Self.ClientHeight - Splitter.Height) div 2;
  tv.Width :=  (pnlTop.ClientWidth - Splitter2.Width) div 2;
end;

function TStoryListForm.ShowItemInList(Item: TBaseItem): Boolean;
  // -------------------------------------------
...
procedure TStoryListForm.AnyClick(Sender: TObject);
begin
...
procedure TStoryListForm.tv_OnDblClick(Sender: TObject);
begin
  EditItem();
end;

procedure TStoryListForm.tv_OnMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
  Node: TTreeNode;
begin
...
procedure TStoryListForm.tv_OnSelectedNodeChanged(Sender: TObject; Node: TTreeNode);
begin
  SelectedNodeChanged();
end;

procedure TStoryListForm.PrepareToolBar();
var
  P: TWinControl;
begin
...
procedure TStoryListForm.ReLoad;
var
  i, j, k: Integer;
  StoryNode: TTreeNode;
...
procedure TStoryListForm.SelectedNodeChanged();
var
  Node: TTreeNode;
  Item: TObject;
  Story: TStory;
...
procedure TStoryListForm.EditItem();
var
  Node: TTreeNode;
  Item: TObject;
begin
...
procedure TStoryListForm.DeleteItem();
var
  Node: TTreeNode;
  Item: TObject;
begin
...
procedure TStoryListForm.EditItemText();
var
  Node: TTreeNode;
  Item: TBaseItem;
begin
  ...
  if Item is TStory then
  begin
    App.ContentPagerHandler.ShowPage(TStoryForm, Item.Id, Item)
  end else if Item is TChapter then
  begin
    App.ContentPagerHandler.ShowPage(TChapterForm, Item.Id, Item)
  end else if Item is TScene then
  begin
    App.ContentPagerHandler.ShowPage(TSceneForm, Item.Id, Item);
  end;

end;

procedure TStoryListForm.AddStory();
var
  Message: string;
  ResultName: string;
  Count: Integer;
...
procedure TStoryListForm.EditStory();
var
  Message: string;
  ResultName: string;
  Count: Integer;
...
begin
  ...
  begin
    ...
    if Assigned(TabPage) and (TabPage.Tag > 0) then
      TStoryForm(TabPage.Tag).TitleChanged();
...
procedure TStoryListForm.DeleteStory();
var
  Message: string;
  Node: TTreeNode;
  Story: TStory;
...
procedure TStoryListForm.AddChapter();
var
  Node: TTreeNode;
  Story: TStory;
  Chapter: TChapter;
...
procedure TStoryListForm.EditChapter();
var
  Message: string;
  ResultName: string;
  Count: Integer;
...
begin
  ...
  begin
    ...
    if Assigned(TabPage) and (TabPage.Tag > 0) then
      TChapterForm(TabPage.Tag).TitleChanged();
...
procedure TStoryListForm.DeleteChapter();
var
  Message: string;
  Node: TTreeNode;
  Chapter: TChapter;
...
procedure TStoryListForm.AddScene();
var
  Node: TTreeNode;
  Chapter: TChapter;
  Scene: TScene;
...
procedure TStoryListForm.EditScene();
var
  Message: string;
  ResultName: string;
  Count: Integer;
...
begin
  ...
  begin
    ...
    if Assigned(TabPage) and (TabPage.Tag > 0) then
      TSceneForm(TabPage.Tag).TitleChanged();
...
procedure TStoryListForm.DeleteScene();
var
  Message: string;
  Node: TTreeNode;
  Scene: TScene;
...
procedure TStoryListForm.ExportStory();
var
  Message: string;
  StoryNode: TTreeNode;
  Story: TStory;
...
procedure TStoryListForm.MoveStory(Story: TStory; Node: TTreeNode; Up: Boolean);
var
  Index: Integer;
begin
...
procedure TStoryListForm.MoveChapter(Chapter: TChapter; Node: TTreeNode; Up: Boolean);
var
...
procedure TStoryListForm.MoveScene(Scene: TScene; Node: TTreeNode; Up: Boolean);
var
  ParentNode: TTreeNode;
begin
...
procedure TStoryListForm.MoveNode(Up: Boolean);
var
  Node: TTreeNode;
  Obj: TObject;
begin
...
procedure TStoryListForm.UpdateNodeTitles(ParentNode: TTreeNode);
var
  N: TTreeNode;
  Item: TBaseItem;
begin
...
procedure TStoryListForm.ChangeParent;
  // --------------------------------------------------------------
...
procedure TStoryListForm.CollapseAll();
begin
  tv.BeginUpdate();
  try
    tv.FullCollapse();
...
procedure TStoryListForm.ExpandAll();
begin
  tv.BeginUpdate();
  try
    tv.FullExpand();
...
procedure TStoryListForm.UpdateTextMetrics();
var
  List: TStringList;
  Item: TCollectionItem;
  Story: TStory;
...
procedure TStoryListForm.OnBroadcasterEvent(Args: TBroadcasterArgs);
var
...
function TStoryListForm.NodeAsObject(Node: TTreeNode): TObject;
begin
...
function TStoryListForm.NodeAsStory(Node: TTreeNode): TStory;
var
  Obj: TObject;
begin
  Result := nil;
...
function TStoryListForm.NodeAsChapter(Node: TTreeNode): TChapter;
var
  Obj: TObject;
begin
  Result := nil;
...
function TStoryListForm.NodeAsScene(Node: TTreeNode): TScene;
var
  Obj: TObject;
begin
  Result := nil;
...
function TStoryListForm.GetStoryNode: TTreeNode;
var
  Item: TBaseItem;
begin
  Result := nil;
...
function TStoryListForm.GetChapterNode: TTreeNode;
var
  Item: TBaseItem;
begin
  Result := nil;
